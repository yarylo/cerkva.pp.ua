...
# main config
PLUGINSLUG="Resize-images-before-upload"
CURRENTDIR=`pwd`
MAINFILE="resize-images-before-upload.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/resize-images-before-upload/" # Remote SVN repo on wordpress.org, with no trailing slash
