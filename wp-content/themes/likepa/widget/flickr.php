 ...
 * Flickr widget
 */
class likepa_flickr_widget extends WP_Widget {
	function likepa_flickr_widget() {
		$widget_ops = array('classname' => 'likepa_flickr_feed', 'description' => __('Displays your flickr photos', "likepa") );
		$this->WP_Widget('likepa_flickr_feed', __('likepa - Flickr', "likepa"), $widget_ops);	
	}
	...
	function form($instance) {
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title', "likepa"); ?>: 
				<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
			</label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('UserID'); ?>"><?php _e('UserID', "likepa"); ?>: <a href="http://get-flickr-id.ubuntu4life.com/" target="_blank"><?php _e('GetFlickr<font color=#FF0084>ID</font>', "likepa"); ?></a>
		...
		<p>
			<label for="<?php echo $this->get_field_id('Number'); ?>"><?php _e('Number to Display', "likepa"); ?>: 
				<input class="widefat" id="<?php echo $this->get_field_id('Number'); ?>" name="<?php echo $this->get_field_name('Number'); ?>" type="text" value="<?php echo esc_attr($Number); ?>" />
			</label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('link'); ?>"><?php _e('Link Text', "likepa"); ?>: 
