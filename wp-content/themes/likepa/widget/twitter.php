...
class likepa_widget_twitter extends WP_Widget{
	
	function likepa_widget_twitter(){
		$widget_ops = array('classname' => 'likepa-twitter', 'description' => __('Display your recent Twitter status.', 'likepa'));
		$control_ops = array('id_base' => 'likepa-twitter');
		$this->WP_Widget('likepa-twitter', 'likepa Twitter Status', $widget_ops, $control_ops);
	}
	...
	function widget($args, $instance){	
		...
		echo $args['before_widget'].$args['before_title'].$twitter_title.$args['after_title'];?>
            ...
            <p id="tweetfollow" class="sidebar_ablock"><a href="http://twitter.com/<?php echo $twitter_username; ?>"><?php _e('Follow me on Twitter', 'likepa') ?></a></p>
            
            <?php do_action('likepa_twitter_widget'); ?>
        <?php echo $args['after_widget']; ?>
        
        <?php
		add_action('wp_footer', 'likepa_add_twitter_script');
	}
	...
	function form($instance){ // Defaults
		$defaults = array(
						...
						'twitter_title' => __('Recent tweets', 'likepa'),
						);
		$instance = wp_parse_args( (array) $instance, $defaults );
		?>
        <p>
        	<label for="<?php echo $this->get_field_id('twitter_title'); ?>"><?php _e('Title:', 'likepa'); ?></label>
        ...
        <p>
        	<label for="<?php echo $this->get_field_id('twitter_username'); ?>"><?php _e('Twitter Username:', 'likepa'); ?></label>
        ...
        <p>
        	<label for="<?php echo $this->get_field_id('twitter_tweetcount'); ?>"><?php _e('Number of tweets to display:', 'likepa'); ?></label>
...
if (!function_exists('likepa_add_twitter_script')) :
	function likepa_add_twitter_script(){
		global $twitter_username;
		global $twitter_tweetcount;
		echo '
